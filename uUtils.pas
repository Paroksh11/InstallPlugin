...
uses
  uDBManager, uAxProvider,uGeneralFunctions,uStructDef,System.SysUtils, System.IOUtils,windows, System.Classes;
...
var
  ...
  reponame: string;
  gitpluginurl: string;
  gitusername, gitpassword, webcodepath,rmqclientpath: string;
